...
const { getFirestore, collection, doc, getDoc, getDocs, setDoc, addDoc } = require('firebase/firestore');
...
async function seedDatabase() {
  ...
  try {
    ...
    if (existingItems.empty && categoriesData.length > 0) {
      ...
      const menuItemsData = [
        ...
        { name: 'رز بحليب', description: 'أرز مطهو بالحملة ومزين بالقرفة', price: '16 ريال', categoryId: categoryMap['الحلويات'] },
